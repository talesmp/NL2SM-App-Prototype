...
def store_usage_log(
    ...
    """
    Insert a row into the usage_logs table. You can expand the arguments
    if you need to store more fields (like 'similarity_score_orig_srs', etc.).
    """
    with sqlite3.connect(DB_PATH) as db_conn:
        db_curs = db_conn.cursor()
        db_curs.execute("""
